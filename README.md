...
│   ├── pages/
│   │   ├── Chatbot.py                  # Chat Interface (calls AI_assistant API)
│   │   └── Exercise_Generator.py       # Exercise UI (calls ExerciceGen API)
│   ├── .env                            # Environment variables
│   └── requirements.txt
│
├── AI/                                 # Backend Microservices
│   ├── AI_assistant/                   # RAG Chatbot Service (Port 5002)
│   │   ├── api_server.py               # FastAPI async server
│   │   ├── rag.py                      # LangChain RAG chain implementation
│   │   ├── chunk3.py                   # 10-step chunking pipeline
│   │   ├── embeddings.py               # Embedding utilities
│   │   ├── store_chroma.py             # ChromaDB indexing script
│   │   ├── chroma_db/                  # Persistent vector store
│   │   │   └── (ChromaDB files)
│   │   ├── processed3_data/            # 550+ preprocessed JSON files
│   │   │   ├── AlgebraAndTrigonometry-OP_1tE6R5r_sanitized.json
│   │   │   ├── CalculusVolume1-OP_sanitized.json
│   │   │   ├── College-Algebra-2e-WEB_sanitized.json
│   │   │   └── ... (547 more math documents)
│   │   ├── chunked_data/               # Processed chunks (JSON)
│   │   ├── rag_metrics_detailed.json   # Performance metrics
│   │   └── Dockerfile
│   │
│   └── ExerciceGen/                    # Exercise Generator (Port 5001)
│       ├── api_server.py               # FastAPI server
│       ├── exercice_generator_rag.py   # RAG-based exercise generation
│       ├── index.py                    # Exercise bank indexing
│       ├── chroma_exercises/           # Exercise vector store
│       ├── subjects_examples.json      # Exercise templates
│       ├── prepare_finetune_data.py    # Fine-tuning data prep
│       └── exercise_generation_metrics.json
│
└── README.md                           # This file
```
